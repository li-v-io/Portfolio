    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {[
        ...
        { 
          ...
          image: `${import.meta.env.BASE_URL}portfolio/BeautifulMathematics.png`
        },
        { 
          ...
          image: `${import.meta.env.BASE_URL}portfolio/KickStartVisualDesign.png`
        },
        { 
          title: "Cinema 4D", 
          ...
          image: `${import.meta.env.BASE_URL}portfolio/Cinema4D.png`
        },
        { 
          title: "Hypnotica", 
